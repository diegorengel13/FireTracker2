...
namespace FireTracker2.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Status")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Status")] TicketStatus ticketStatus)
        {
            if (ModelState.IsValid)
            {
